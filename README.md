# 微信支付 API v3 Go SDK
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/Marek-maxs/wechatpay-go)
[![huntr](https://cdn.huntr.dev/huntr_security_badge_mono.svg)](https://huntr.dev)
[![licence](https://badgen.net/github/license/wechatpay-apiv3/wechatpay-go)](https://github.com/Marek-maxs/wechatpay-go/blob/main/LICENSE)
...
```shell
go get -u github.com/Marek-maxs/wechatpay-go
```
...
import (
	"log"
	"github.com/Marek-maxs/wechatpay-go/services/payments/jsapi"
)
...
import (
	...
	"github.com/Marek-maxs/wechatpay-go/services/fileuploader"
)
...
import (
	...
	"github.com/Marek-maxs/wechatpay-go/core"
	"github.com/Marek-maxs/wechatpay-go/core/auth/credentials"
	"github.com/Marek-maxs/wechatpay-go/core/auth/validators"
	"github.com/Marek-maxs/wechatpay-go/core/option"
)
...
[#35](https://github.com/Marek-maxs/wechatpay-go/issues/35) 是一个很好的参考。
...
## 联系微信支付
如果你发现了 BUG，或者需要的功能还未支持，或者有任何疑问、建议，欢迎通过 [issue](https://github.com/Marek-maxs/wechatpay-go/issues) 反馈。
